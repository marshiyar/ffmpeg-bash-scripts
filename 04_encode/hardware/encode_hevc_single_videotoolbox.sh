#!/usr/bin/env bash
# Single-file hardware encode to HEVC using hevc_videotoolbox.
# Usage: ./encode_hevc_single_videotoolbox.sh <input> [output] [bitrate] [realtime]
# Defaults: output=<input>_hevc_vt.mp4, bitrate=6M, realtime=false
